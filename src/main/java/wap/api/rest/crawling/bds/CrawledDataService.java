...
//    String fromPass = "xrztwxsjasjzjayg";
    ...
    String title = "Ưu đãi cực lớn Block cuối cùng và đẹp nhất khu EMERALD dự án Celadon city !!!1231231231";

    StringBuilder email = new StringBuilder();

    email.append("Xin chào Anh/Chị, <br/> ");
    email.append("Celadon city thông báo đến quý khách hàng chương trình bán hàng block E ngày 18/3/2018; là block cuối cùng khu Emerald. <br><br>");
    ...
    email.append("   Facebook: https://www.facebook.com/tuvandautubatdongsanhochiminh <br>");

...
//    String fromPass = "xrztwxsjasjzjayg";
    ...
    String title = "SỐNG KHỎE - SỐNG VUI tại Celadon city 12345";
    ...
    email.append("Celadon City - “Đô thị xanh dẫn đầu xu thế” <br>");
      ...
      for (ContactPresenter contactPresenter : list) {
        ...
        if (!this.crawledDataDao.checkEmailSentOrNotWithTitle(title, contactPresenter.getEmail())) {
          try {
            ...
            this.crawledDataDao.trackEmailSent(from, contactPresenter.getEmail(), title, StringUtils.stripAccents(email.toString()));

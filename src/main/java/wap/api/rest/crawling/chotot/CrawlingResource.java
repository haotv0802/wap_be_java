package wap.api.rest.crawling.chotot;
 ...
 * @author haho
 */
@RestController("chototCrawlingResource")
@RequestMapping(path = "/svc/chotot")
public class CrawlingResource {
  ...
  public CrawlingResource(
      @Qualifier("chototCrawlingService") ICrawlingService crawlingService
  ) {
  ...
  public Map<String, CrawlingTracking> crawlingData(
    ...
    if (StringUtils.isEmpty(link)) {
      pages.add("https://nha.chotot.com/tp-ho-chi-minh/mua-ban-nha-dat");
    } else {
      pages.add(link);
    }

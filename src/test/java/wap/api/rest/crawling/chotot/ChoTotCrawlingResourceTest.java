 ...
 */
public class ChoTotCrawlingResourceTest extends TestBase {

  @Test
  public void testCrawlingData() throws Exception {
    mockMvc
        .perform(get("/svc/chotot/crawler/crawlingData")
            .param("link", "https://nha.chotot.com/tp-ho-chi-minh/mua-ban-nha-dat")
        )
